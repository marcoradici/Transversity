      ...
      iloop = 1
      nf = 5
      call hoppetEvalSplit(x,Q,iloop,nf,PLO_conv_ourpdf,0)
      ! extract the convolution with the 2-loop (NLO) splitting function
      iloop = 2
      call hoppetEvalSplit(x,Q,iloop,nf,PNLO_conv_ourpdf,0)
