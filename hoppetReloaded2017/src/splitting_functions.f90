...
!
!
! MG 20.11.2009 Added codd_* splitting functions
!
...
!!--------------------------------------------------------------------------
  ...
  public :: codd_Pgg, codd_Pqq, codd_Pgq, codd_Pqg
...
!!--------------------------------------------------------------------------
  ...
  !----------------------------------------------------------------------
  function codd_Pgg(y) result(res)
    real(dp), intent(in) :: y
    real(dp)             :: res
    real(dp)             :: x
    x = exp(-y)
    ...
    !if (cc_piece /= cc_DELTA) res = res * x
  end function codd_Pgg

  !----------------------------------------------------------------------
  function codd_Pqq(y) result(res)
    real(dp), intent(in) :: y
    real(dp)             :: res
    real(dp)             :: x
    x = exp(-y)
    ...
    if (cc_piece /= cc_DELTA) res = res * x
  end function codd_Pqq

  !----------------------------------------------------------------------
  function codd_Pgq(y) result(res)
    real(dp), intent(in) :: y
    real(dp)             :: res
    real(dp)             :: x
    x = exp(-y)
    ...
    !if (cc_piece /= cc_DELTA) res = res * x
  end function codd_Pgq

  !----------------------------------------------------------------------
  function codd_Pqg(y) result(res)
    real(dp), intent(in) :: y
    real(dp)             :: res
    real(dp)             :: x
    x = exp(-y)
