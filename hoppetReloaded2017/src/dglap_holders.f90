...
!!
!! MG 20.11.2009 Added case (factscheme_FragCOddMSbar)
!!
...
!! MG 20.11.2009 -START-
!!--------------------------------------------------------------------------
       case (factscheme_FragCOddMSbar)
          if (dh%nloop >= 2) call wae_error('InitDglapHolder',&
               &'nloop >= 2 not supported for fragmentation chiral-odd case')
          call InitSplitMatFragCOddLO(grid, dh%P_LO)
!!--------------------------------------------------------------------------
!! MG 20.11.2009 -END-
!!--------------------------------------------------------------------------
