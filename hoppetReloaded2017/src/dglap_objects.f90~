...
!!
!!
!! MG 20.11.2009 Added InitSplitMatFragCOddLO
!!
!======================================================================
...
!!--------------------------------------------------------------------------
  ...
  subroutine InitSplitMatFragCOddLO(grid, P)
    use qcd
    type(grid_def),  intent(in)    :: grid
    type(split_mat), intent(inout) :: P
    ...
    call InitGridConv(grid, P%gg, codd_Pgg)
    call InitGridConv(grid, P%qq, codd_Pqq)
    call InitGridConv(grid, P%gq, codd_Pgq)
    call InitGridConv(grid, P%qg, codd_Pqg)
    ...
    !-- PNSminus + nf * (PqqS - PqqbarS)
    call InitGridConv(P%NS_V, P%NS_minus)
  end subroutine InitSplitMatFragCoddLO
